        ...
        <div className="flex-1 overflow-y-auto p-8 z-0">
          <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
            ...
            {activeTab === 'assessments' && (
              <div className="space-y-8">
                 <div className="relative overflow-hidden rounded-[40px] bg-white border border-teal-100 p-12 flex flex-col md:flex-row items-center justify-between shadow-2xl"><div className="relative z-10 max-w-2xl"><span className="px-4 py-1.5 bg-teal-100 text-teal-800 text-[10px] font-black rounded-full uppercase mb-6 inline-block tracking-widest">Instrumen Validasi</span><h3 className="text-4xl font-black text-slate-900 mb-4 tracking-tight uppercase italic">PDI-DL: Preliminary Diagnostic</h3><p className="text-slate-600 mb-8 text-lg font-medium italic">Uji pemetaan profil awal literasi digital mahasiswa calon guru.</p><button onClick={() => router.push('/assessment/preliminary')} className="bg-teal-600 hover:bg-teal-700 text-white font-black px-10 py-4 rounded-2xl shadow-xl shadow-teal-500/30 flex items-center gap-3 transition-all">Mulai Asesmen Sekarang <i className="fa-solid fa-arrow-right"></i></button></div><i className="fa-solid fa-file-signature text-[150px] text-teal-500 opacity-20"></i></div>
