    ...
    <div className="min-h-screen bg-[#0B1120] flex flex-col items-center justify-center p-6"
      ...
      {!submitted ? (
        ...
        <div className="max-w-2xl w-full bg-[#1E293B]/90 backdrop-blur-3xl rounded-[30px] p-12 shadow-2xl border border-slate-700/50 text-center animate-in fade-in duration-500">
          ...
          <p className="text-slate-400 mb-8 font-medium text-sm">Data Asesmen dan Survei Usability Anda telah berhasil direkam oleh sistem.</p>
          
          {/* HASIL ANALISIS SEMENTARA SEBELUM KEMBALI KE DASHBOARD */}
          <div className="bg-slate-900/60 rounded-2xl p-6 border border-slate-700/50 mb-8 text-left space-y-6">
             <h3 className="text-xs font-bold text-blue-400 uppercase tracking-widest border-b border-slate-700 pb-2"><i className="fa-solid fa-microchip mr-2"></i> Ringkasan Analisis Real-time</h3>
             
             <div className="grid grid-cols-2 gap-4">
                <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700">
                   <p className="text-[10px] text-slate-400 font-bold uppercase mb-1">Skor MADEL5C</p>
                   <p className="text-2xl font-black text-white">82/100</p>
                   <p className="text-[9px] text-emerald-400 uppercase mt-1">Level Lanjut</p>
                </div>
                <div className="bg-blue-900/20 p-4 rounded-xl border border-blue-500/20">
                   <p className="text-[10px] text-blue-400 font-bold uppercase mb-1">Skor SUS Anda</p>
                   <p className="text-2xl font-black text-white">92.5</p>
                   <p className="text-[9px] text-blue-300 uppercase mt-1">Excellent Grade</p>
                </div>
             </div>
             
             <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700">
                <p className="text-[10px] text-slate-400 font-bold uppercase mb-2">Diagnosa AI Preliminary</p>
                <p className="text-sm text-slate-300 leading-relaxed italic">"Kemampuan Literasi Informasi Anda sangat memuaskan. Fokus selanjutnya yang direkomendasikan adalah pada pengembangan Pedagogi Digital."</p>
             </div>
          </div>

          <button onClick={() => router.push('/dashboard?survey=done')}
                  className="w-full bg-slate-800 hover:bg-slate-700 text-white font-bold py-4 rounded-xl border border-slate-600 transition-all flex items-center justify-center gap-3 text-sm uppercase tracking-widest">
